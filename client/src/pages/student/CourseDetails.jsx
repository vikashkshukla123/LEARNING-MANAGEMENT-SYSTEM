...
const CourseDetails = () => {
  ...
  return courseData ? (
    <>
   <div className="relative min-h-[600px] flex md:flex-row flex-col-reverse gap-10 items-start justify-between md:px-36 
px-8 md:pt-30 pt-20 text-left">

  {/* Gradient */}
  <div className="absolute top-0 left-0 w-full h-[500px] z-[-1] bg-linear-to-b from-cyan-100/70 to-transparent"></div>
  ...
  className="
    max-w-[424px] 
    z-10 
    shadow-[0px_4px_15px_2px_rgba(0,0,0,0.1)] 
    rounded-t 
    md:rounded-none 
    overflow-hidden 
    bg-white 
...
>
  ...
  <div className="p-5">
    ...
    <div className='flex gap-3 items-center pt-2'>
      <p className='text-gray-800 md:text-4xl text-2l font-semibold'>
 ...
 <button onClick={enrollCourse} className='md:mt-6 w-full py-3 rounded bg-blue-600 text-white 
 font-medium'>{isAlreadyEnrolled ? 'Already Enrolled' : 'Enroll Now'}</button>
 <div className='pt-6'>
  <p className='md:text-xl text-lg font-medium text-gray-800'>What's in the course</p>
  <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
    <li>Liftime access with free updates.</li>
